...
| 2026-07-02 | csv-select | `csv-select` | Extract selected columns from CSV input while preserving row order. |
| 2026-07-01 | file-hash | `file-hash` | Compute file or stdin digests with a selectable hash algorithm. |
| 2026-07-01 | text-stats | `text-stats` | Summarize characters, words, lines, sentences, and paragraphs in text input. |
